...
const MoviePage = () => {
  ...
  if (loading)
    return (
      <div className="min-h-screen flex items-center justify-center text-gray-500 uppercase tracking-widest">
        Chargement...
      </div>
    );
  if (!movieData)
    return (
      <div className="min-h-screen flex items-center justify-center text-red-500 uppercase">
        Film non trouvé
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-20">
      <div className="max-w-4xl mx-auto px-4 pt-6">
        <Link
          to="/gallery"
          className="inline-flex items-center text-sm font-bold text-[#2563EB] mb-6 hover:opacity-70"
        >
