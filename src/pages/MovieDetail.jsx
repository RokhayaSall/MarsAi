        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-8 space-y-16">
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <MovieInfo
                ...
                variant="minimal" // Tu pourras adapter ton composant pour un style sombre
              />
            </div>
          ...
          <aside className="lg:col-span-4 sticky top-12 space-y-6">
            <div className="bg-slate-900/40 backdrop-blur-xl rounded-[2rem] p-8 border border-white/5 shadow-2xl">
              <h4 className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mb-8">
                Specifications
              </h4>

              <div className="space-y-8">
                <div className="group">
                  <p className="text-[9px] text-blue-500 font-black uppercase mb-1 tracking-tighter">
                    Runtime
                  </p>
                  <p className="text-3xl font-light tracking-tight">
                    {movieData.duration}
                    <span className="text-sm text-slate-500 ml-1 italic">
                      min
                    </span>
                  </p>
                </div>
                ...
                <div className="pt-6 mt-6 border-t border-white/5">
                  <div className="flex items-center justify-between p-4 bg-blue-500/5 rounded-2xl border border-blue-500/10">
                    <span className="text-[10px] font-bold text-blue-300 uppercase italic">
                      Status
                    </span>
            ...
            {/* Call to action ou Badge supplémentaire */}
